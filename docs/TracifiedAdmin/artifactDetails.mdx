...
[Master Data](../docs/intro#artifacts--master-data) are referred to as [Artifacts](../docs/intro#artifacts--master-data) in Tracified. [Artifacts](../docs/intro#artifacts--master-data) can be created here, as per the requirement. 
...
Already created and saved artifact templates can also be viewed, in order to know how and what should be done in creating the [artifacts](../docs/intro#artifacts--master-data).  

:white_check_mark: If they are appropriate, they can be used to proceed, instead of creating new [artifacts](../docs/intro#artifacts--master-data)


![MarineGEO circle logo](../../static/img/artifact6.png "MarineGEO logo")

Previously created and saved templates can be used to proceed, instead of creating new [artifacts](../docs/intro#artifacts--master-data), if they are appropriate.
[Artifacts](../docs/intro#artifacts--master-data) can also be deleted if they are inappropriate or not in use anymore. Once the delete alert is confirmed, the selected artifact will be completely deleted and will no longer be available to use. 

Once an artifact is selected to be used, the list of already saved records(refed as [master Data](../docs/intro#artifacts--master-data)) will be published. You can add new records by clicking on the ‘+ New Record’ button and all text fields must be filled in order to save the record successfully. 
